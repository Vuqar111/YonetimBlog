...
import { orderDelete, orderList } from '../redux/slices/orderSlice';
interface Order {
  _id: number;
  title: string;
  price: number;
...
const OrderListTable: React.FC<Props> = ({ data }) => {
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="grid grid-cols-6 border-t border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
          <div className="col-span-3 flex items-center">
            <p className="font-medium">Sifariş ID</p>
          </div>


          <div className="col-span-1 flex items-center">
            <p className="font-medium">Yekun qiymət</p>
          </div>
          <div className="col-span-1 flex items-center">
        ...
        {data?.map((order, i) => {
          return (
            ...
            >
              ...
              <div className="col-span-1 flex items-center">
                <p className="text-sm text-meta-3">{order?.totalPrice} AZN</p>
              </div>

              <div className="col-span-1 flex items-center">
                <p className="text-sm text-black dark:text-white ">
                  {/* {order?.createdAt}  */} 2023.10.14
                </p>
              </div>
              <div className="col-span-1 flex items-center">
